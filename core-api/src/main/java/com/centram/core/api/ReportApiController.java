...
public class ReportApiController {
    ...
    public ResponseEntity<Resource> uatScriptReportDownload(
        ...
        final InputStreamResource resource = new InputStreamResource(reportService.uatScriptReportDownload( start,  end,  Technology.valueOf(technology),  moduleId,  subModuleId,  projectId,  projectUatId,  projectUatScriptId,  uploadedByUserId, status, Pageable.unpaged()));
