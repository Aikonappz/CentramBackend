...
public class ReportApiController {
    ...
    public ResponseEntity<PaginatedList<Incident>> incidentReport(
             ...
             @RequestParam(value = "agingFilter", defaultValue = "", required = false) String agingFilter,
             @RequestParam(value = "raisedUserId", defaultValue = "", required = false) String raisedUserId,
             @RequestParam(value = "assignedUserId", defaultValue = "", required = false) String assignedUserId,
             @RequestParam(value = "status", defaultValue = "", required = false) String status,
             @RequestParam(value = "allOpen", defaultValue = "false", required = false) Boolean allOpen,
             @RequestParam(value = "allClosed", defaultValue = "false", required = false) Boolean allClosed,
             @RequestParam(value = "isReopened", defaultValue = "false", required = false) Boolean isReopened,
