...
public class UserApiController {
    ...
    @PreAuthorize("@appSecurityUtilityService.hasPermission('ASSET ASIGNMENT REPORT,USER,MY INCIDENTS,MY GROUP INCIDENTS,ORDER ASSET','READ,READ,WRITE|SEARCH,WRITE|SEARCH,READ|WRITE',authentication.principal) || @appSecurityUtilityService.hasCategoryAdminAccess(authentication.principal)")
