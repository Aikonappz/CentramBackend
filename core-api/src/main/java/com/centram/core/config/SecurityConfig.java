    ...
    public static class RestApiSecurity extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity httpSecurity) throws Exception {
            httpSecurity
                    ...
                    .antMatchers(HttpMethod.POST, "/api/v1/user/sign-in", "/api/v1/user/sso-sign-in", "/api/v1/user/forgot-password", "/api/v1/user/change-password","/api/v1/user/reset-password", "/api/v1/misc/request-demo").permitAll()
