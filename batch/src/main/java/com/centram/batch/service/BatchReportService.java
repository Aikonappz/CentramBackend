...
public class BatchReportService {
    ...
    public void generateIncidentReport(
        ...
        PaginatedList<Incident> page = incidentService.incidentReport(null, null, null, null, null, null, IncidentStatus.ALL.ordinal(), start, end, Pageable.unpaged(), true, roleNames, organisationId);
