...
export class AssetOrderActionDataSource implements DataSource<AssetOrder>{
    ...
    constructor(private service: AssetOrderService) { }
    ...
    loadData(pageNumber = 0, pageSize = 10, req = {}) {
        ...
        this.service.assetOrderForApprovalService(params)
            .pipe(
                catchError(() => of([])),
