...
import { OrganisationDetailModal } from './modal/ViewOrganisationDetailModal';
...
export class OrganisationComponent implements OnInit, OnDestroy {
  ...
  edit(org: Organisation) {
    this.router.navigate(['/supadmin/organization/edit/' + org.id]);
  }
  add() {
    this.router.navigate(['/supadmin/organization/add']);
  }
  loadPage() {
    this.angForm.reset();
    this.loadData({});
