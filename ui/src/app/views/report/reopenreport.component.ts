...
import { ReportReopenIncidentDataSource } from '../../service/datasource/ReportReopenIncidentDataSource';
...
@Component({
  selector: 'app-reopenreport',
  templateUrl: './reopenreport.component.html',
  styleUrls: ['./reopenreport.component.scss']
})
export class ReopenReportComponent implements OnInit {
  moduleName: string = "REOPEN REPORT";
  //actions: string[] = ["READ", "DELETE", "SEARCH", "WRITE"];
  displayedColumns = ['incDtl', 'slaAt', 'assignedUser', 'status',];
  datasource: ReportReopenIncidentDataSource;
  ...
  download() {
    this.service
      .downloadIncidentReopenReport(this.searchedData)
      .subscribe((data: any) => {
        //console.log(data);
